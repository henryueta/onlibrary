...
const useHandleForm = (typeOfForm:TableType)=>{
    ...
    //     onAxiosQuery("get",
    //         {
    //             url:"https://onlibrary-server-fkrn.vercel.app/data/group?type=book&id=1d8fq",
    //             type:{
    //                 get:{
    //
    //                 }
        ...
        const checkQueryType = {
            ...
            select:()=>{
              console.log(form.type)
                onAxiosQuery("get",{
                    url:`https://onlibrary-server-fkrn.vercel.app/data/group?type=${form.type}&id=${libraryId}&userId=${current_userId.user_id}`,
                    type:{
                        get:{}
                    },
                    onResolver:{
               ...
               (()=>{
                const checkTables = {
                        ...
                        return (
                            {
                                ...
                                url:"https://onlibrary-server-fkrn.vercel.app/data/create?type=library&userId="+current_userId.user_id,
                                data:{
                    ...
                    book:()=>{
                        ...
                        return (
                            {
                                url:"https://onlibrary-server-fkrn.vercel.app/book/post",
                                data:{
                                    ISBN:book_data.ISBN,
                    ...
                    account:()=>{
                      const account_data = form.data as AccountTableQueryProps;
                        return (
                            {
                                url:"https://onlibrary-server-fkrn.vercel.app/account/post",
                                data:{
                    ...
                    library_user:()=>{
                        ...
                        return (
                            {
                                url:"https://onlibrary-server-fkrn.vercel.app/library_user/post",
                                data:{
                    ...
                    loan:()=>{
                      const loanData = form.data as LoanTableQueryProps;
                        return (
                            {
                                url:"https://onlibrary-server-fkrn.vercel.app/loan/post",
                                data:{
                    ...
                    exemplary:()=>{
                      ...
                      const exemplaryData = form.data as ExemplaryTableQueryProps
                        return (
                            {
                                url:"https://onlibrary-server-fkrn.vercel.app/exemplary/post",
                                data:{
